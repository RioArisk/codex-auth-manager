  ...
  return (
    <div 
      className={`
        ...
        ${isActive 
          ? 'bg-gradient-to-br from-amber-900/40 to-stone-800 border-2 border-amber-500 shadow-lg shadow-amber-500/20' 
          : 'bg-stone-800/80 border border-stone-700 hover:border-stone-600'
        }
      `}
    >
      {/* 活动标记 */}
      {isActive && (
        <div className="absolute -top-2 -right-2 px-2 py-0.5 bg-amber-500 text-white text-xs font-medium rounded-full animate-pulse-glow">
          当前使用
        </div>
      )}
      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-stone-400 text-sm">{accountInfo.email}</p>
          </div>
        </div>
      ...
      {usageInfo ? (
        <div className="space-y-3 mb-4">
          ...
          {/* 上下文窗口 */}
          <div className="flex justify-between text-sm text-stone-400 pt-2 border-t border-stone-700">
            <span>上下文窗口</span>
        ...
        <div className="py-6 text-center text-stone-500 mb-4">
